...
- `**qahal**` / `**Qahal**` — intraduisible : l'assemblée ==convoquée par une autorité== (קָהָל). Non « assemblée » ni « communauté », qui laissent croire à une réunion qu'on décide : au **qahal** on ==est appelé==. C'est le mot du jour du [[Sinai]] (*Deutéronome* 9:10, *yom ha-qahal*), et c'est celui que le grec rendra par *ekklesia*. 123 emplois.
  ==Le verbe s'écrit exactement comme le nom==, et il est déclaré ici plutôt qu'à part : `6950`, 38 emplois, pas une lettre de différence. Ce n'est pas la contrainte d'outil de **malakh** — c'est ==un fait de la langue==, et il dit ce que le mot veut dire : le **qahal** n'existe pas avant qu'on l'ait convoqué, donc ==l'acte et la chose portent le même nom==. Le hiphil *vayaqhel* a pour sujet ==celui qui appelle==, le niphal *vayiqahalu* ==ceux qui viennent== : la langue sépare les deux rôles que le français fond dans « s'assembler ».
  `**qehillah**` (קְהִלָּה) suit la même racine — ==deux emplois en tout==, trop peu pour porter une distinction, et signalés comme tels.
